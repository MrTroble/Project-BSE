...
#include <TGEngine/TGEngine/public/headerlibs/enum.h>
#include <TGEngine/TGEngine/public/graphics/MaterialExt/BlendFactorExt.hpp>
...
namespace tge::nif {
	...
	BETTER_ENUM(NifAlphaFunction, uint16_t,
		ONE, ZERO, SRC_COLOR, INV_SRC_COLOR, DEST_COLOR,
		INV_DEST_COLOR, SRC_ALPHA, INV_SRC_ALPHA, DEST_ALPHA,
		INV_DEST_ALPHA, SRC_ALPHA_SATURATE);

	vk::BlendFactor fromNifAlphaFunction(
		NifAlphaFunction function) {
		switch (function) {
		case NifAlphaFunction::ONE:
			return vk::BlendFactor::eOne;
		case NifAlphaFunction::ZERO:
			return vk::BlendFactor::eZero;
		case NifAlphaFunction::SRC_COLOR:
			return vk::BlendFactor::eSrcColor;
		case NifAlphaFunction::INV_SRC_COLOR:
			return vk::BlendFactor::eOneMinusSrcColor;
		case NifAlphaFunction::DEST_COLOR:
			return vk::BlendFactor::eDstColor;
		case NifAlphaFunction::INV_DEST_COLOR:
			return vk::BlendFactor::eOneMinusDstColor;
		case NifAlphaFunction::SRC_ALPHA:
			return vk::BlendFactor::eSrcAlpha;
		case NifAlphaFunction::INV_SRC_ALPHA:
			return vk::BlendFactor::eOneMinusSrcAlpha;
		case NifAlphaFunction::DEST_ALPHA:
			return vk::BlendFactor::eDstAlpha;
		case NifAlphaFunction::INV_DEST_ALPHA:
			return vk::BlendFactor::eOneMinusDstAlpha;
		case NifAlphaFunction::SRC_ALPHA_SATURATE:
			return vk::BlendFactor::eSrcAlphaSaturate;
		default:
			throw std::runtime_error(
				"Unknown NifAlphaFunction value: " + std::to_string(static_cast<uint16_t>(function)));
		}
	}

	BETTER_ENUM(NifTestFunction, uint32_t, ALWAYS, LESS,
		EQUAL, LESS_EQUAL, GREATER, NOT_EQUAL, GREATER_EQUAL, NEVER);

	struct NifAlphaReader {
		nifly::NiAlphaProperty property;

		inline bool HasAlphaBlend() const {
			return property.flags & 0x0001;
		}

		inline NifAlphaFunction GetSourceBlendMode() const {
			return NifAlphaFunction::_from_index_unchecked(property.flags & 0x001E >> 1);
		}

		inline NifAlphaFunction GetDestinationBlendMode() const {
			return NifAlphaFunction::_from_index_unchecked(property.flags & 0x01E0 >> 5);
		}

		inline bool HasAlphaTest() const {
			return property.flags & 0x0200;
		}

		inline NifTestFunction GetAlphaTestFunction() const {
			return NifTestFunction::_from_index_unchecked(property.flags & 0x1C00 >> 10);
		}
	};
